...
<a name="method60"></a>
<p/><strong>int Info::LHEFversion() &nbsp;</strong> <br/>
...
information is <code>main102.cc</code>.
...
<a name="method61"></a>
<p/><strong>int Info::getInitrwgtSize() &nbsp;</strong> <br/>
...
<a name="method62"></a>
<p/><strong>int Info::getGeneratorSize() &nbsp;</strong> <br/>
  

<p/> 
The contents of a <code>&lt;generator&gt;</code> tag can be accessed through the 
method

</p>
<strong>string Info::getGeneratorValue(unsigned int n = 0) &nbsp;</strong> <br/>
...
<strong>string Info::getGeneratorAttribute(unsigned int n, string key,bool doRemoveWhitespace = false) &nbsp;</strong> <br/>
...
<p/>
<a name="method63"></a>
<p/><strong>unsigned int Info::getWeightsDetailedSize() &nbsp;</strong> <br/>
...
<a name="method64"></a>
<p/><strong>double Info::getWeightsDetailedValue(string n) &nbsp;</strong> <br/>
...
<a name="method65"></a>
<p/><strong>string Info::getWeightsDetailedAttribute(string n, string key,    bool doRemoveWhitespace = false) &nbsp;</strong> <br/>
...
<p/>
<a name="method66"></a>
<p/><strong>unsigned int Info::getWeightsCompressedSize() &nbsp;</strong> <br/>
...
<a name="method67"></a>
<p/><strong>double Info::getWeightsCompressedValue(unsigned int n) &nbsp;</strong> <br/>
...
<a name="method68"></a>
<p/><strong>string Info::getWeightsCompressedAttribute(string key,    bool doRemoveWhitespace = false) &nbsp;</strong> <br/>
...
<strong>string Info::getScalesValue() &nbsp;</strong> <br/>
...
<a name="method69"></a>
<p/><strong>double Info::getScalesAttribute(string key) &nbsp;</strong> <br/>
...
supported. Attributes of the <code>&lt;event&gt;</code> tag can be accessed
by 

<a name="method70"></a>
<p/><strong>string Info::getEventAttribute(string key, bool doRemoveWhitespace = false) &nbsp;</strong> <br/>
