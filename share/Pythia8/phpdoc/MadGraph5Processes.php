...
MadGraph5_aMC@NLO inside PYTHIA, either by exporting  Madgraph process 
code or by wrapping the MadGraph5_aMC@NLO generator as a PYTHIA 
...
executable that <code>LHAupMadgraph</code> is meant to wrap. For 
leading-order generation "mg5" would be an alternative. In additon 
...
commands beginning with <code>" set"</code> are used in the launch stage, 
commands begining with <code>"config"</code> are used in the configuration 
stage, and all remaining commands (excluding <code>output</code> and 
...
this strategy, one can generate Pythia jobs with seeds from 0 to 30081, 
