...
<input type="radio" name="9" value="7"><strong>7 </strong>: the ACTW B NLO <ei>Q^2</ei>-dependent  parametrization with <ei>epsilon=0.14</ei>,  based on a tune to H1 and ZEUS data <ref>Alv99</ref>,  rescaled by the factor <code>PomRescale</code> below.  <br/>
<input type="radio" name="9" value="8"><strong>8 </strong>: the ACTW D NLO <ei>Q^2</ei>-dependent  parametrization with <ei>epsilon=0.14</ei>,  based on a tune to H1 and ZEUS data <ref>Alv99</ref>,  rescaled by the factor <code>PomRescale</code> below.  <br/>
<input type="radio" name="9" value="9"><strong>9 </strong>: the ACTW SG NLO <ei>Q^2</ei>-dependent  parametrization with <ei>epsilon=0.14</ei>,  based on a tune to H1 and ZEUS data <ref>Alv99</ref>,  rescaled by the factor <code>PomRescale</code> below.  <br/>
<input type="radio" name="9" value="10"><strong>10 </strong>: the ACTW D NLO <ei>Q^2</ei>-dependent  parametrization with <ei>epsilon=0.19</ei>,  based on a tune to H1 and ZEUS data <ref>Alv99</ref>,  rescaled by the factor <code>PomRescale</code> below.  <br/>
