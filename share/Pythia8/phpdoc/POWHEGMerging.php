...
apply also to W/Z emissions) are not included.   This effect can be investigated
using <code>POWHEG:QEDveto = 0,1,</code> or <code>2</code>.   For the default
value of <code>POWHEG:pTemt = 0</code>, only <code>POWHEG:QEDveto = 2</code> has
any effect.   For this choice, a hard photon and subsequent QCD radiation is 
retained.  In many cases, particularly when the Born contributions are small,
