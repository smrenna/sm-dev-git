...
<a name="method4"></a>
<p/><strong>void ParticleData::init(const ParticleData &particleDataIn) &nbsp;</strong> <br/>
read in the database from an existing <code>ParticleData</code> object. 
...
<a name="method8"></a>
<p/><strong>bool ParticleData::copyXML(const ParticleData &particleDataIn) &nbsp;</strong> <br/>
auxiliary to copy and process XML information from another particleData 
object. 
   
<br/><strong>bool ParticleData::loadXML(string inFile, bool reset = true) &nbsp;</strong> <br/>
auxiliary to load a specific XML file into memory (which may refer to others). 
   
<br/><strong>bool ParticleData::processXML(bool reset = true) &nbsp;</strong> <br/>
auxiliary to process XML contents stored in memory. 
