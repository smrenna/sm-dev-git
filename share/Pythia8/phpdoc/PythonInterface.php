...
<li>Classes where the <code>&lt&lt</code> operator, 
a <code>print</code> function, or a <code>list</code> function, can be 
printed via the built-in <code>print</code> function in Python. Note 
this means that a string representation via <code>str</code> is also 
available for these classes in Python. The <code>print</code> 
function, when defined for a PYTHIA class, is also available in the 
Python interface as <code>list</code>.</li> 
