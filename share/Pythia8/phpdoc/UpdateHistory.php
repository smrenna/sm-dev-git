...
distributions sensitive to angular correlations. New switches 
...
<i>p p</i>, and an option to rescale the Pomeron flux. Some default 
values changed, notably that now MPI is checked.</li> 
