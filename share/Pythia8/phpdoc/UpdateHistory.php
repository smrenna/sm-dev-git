...
<li>PDG codes 51 - 60 have been reserved for Dark Matter particles.
51, 52 and 53 are intended for spin 0, 1/2 and 1 options, respectively, 
whereas the rest can be used freely, say in models with several
Dark Matter particles. Masses should be set appropriately.
By default all have separate antiparticles, with negative codes. These 
can be removed by setting the antiparticle name to be "void". 
The <code>ParticleData::antiName(...)</code> method has been fixed to 
accept this, just like <code>ParticleData::names(...)</code> already did. 
</li>
