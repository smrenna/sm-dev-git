...
dilution of the effect. The enhancement factor is now also calculated 
at initialization, for internal usage.</li> 
 
<li>New method <code>Settings::getReadHistory</code> returns a vector 
with all strings that have been read in by the 
<code>Settings::readString()</code> method, and thereby also the 
settings part of the <code>Pythia::readString()</code> and 
<code>Pythia::readFile()</code> commands. (Still to be expanded?) 
</li> 
